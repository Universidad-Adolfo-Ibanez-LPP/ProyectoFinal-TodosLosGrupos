...
public class FarmazonParser extends UAIAbstractParser {

    public FarmazonParser(UF uf) {
        super("https://www.farmazon.cl/catalogsearch/result/?q=", uf);
    }
    ...
    public HashSet<Medicamento> parseMedicamentos(String principio_activo, int page) throws IOException {
        ...
        for (Element card : medicamentosElements) {
            ...
            //Cargo la farmacia
            medicamento.setFarmacia("farmazon");
