...
def attach_price_to_drugstoredesv(list):
  farmacias=["Ahumada", "Salcobrand", "Redfarma"]
  lista=[]
  for i in range(len(farmacias)):

    diccionari={"farmacia": farmacias[i], "desviacion_estandar":list[i]}
    lista.append(diccionari)
  return lista

def attach_price_to_drugstorevar(list):
  farmacias=["Ahumada", "Salcobrand", "Redfarma"]
  lista=[]
  for i in range(len(farmacias)):

    diccionari={"farmacia": farmacias[i], "varianza":list[i]}
    lista.append(diccionari)
  return lista
